...
class FoodCourseCommentData: NSObject {
    var count : String?
    var data : Array<FoodCourseCommentDatail>?
    var page : String?
    var size : String?
    var total : String?
    ...
    class func parse(json:JSON)->FoodCourseCommentData{
        ...
        var tmpArray = Array<FoodCourseCommentDatail>()
        for (_,subJson) in json["data"] {
            let dModel = FoodCourseCommentDatail.parse(subJson)
            tmpArray.append(dModel)
        }
        model.data=tmpArray
...
class FoodCourseCommentDatail: NSObject {
    var content : String?
    ...
    var parents : Array<FoodCourseCommentDatail>?
    var relate_id : String?
    var type : String?
    var user_id : String?
    
    class func parse(json:JSON)-> FoodCourseCommentDatail{
        let model = FoodCourseCommentDatail()
        ...
        var array = Array<FoodCourseCommentDatail>()
        for (_,subJson) in json["parents"] {
            let pModel = FoodCourseCommentDatail.parse(subJson)
            array.append(pModel)
        }
        model.parents = array
